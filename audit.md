...
###### Does the `CaptchaComponent` challenge the user to identify images from a grid?

###### Can the user revisit previous stages of the challenge?
...
###### Does the results page display the challenge results and provide the option to restart a new challenge?

###### Is direct access to the results page prevented unless the challenges are completed?
...
###### +Are there multiple sets of challenges (e.g., image selection, math, text input) that can be randomly assigned to each session?
...
###### +Do the tests cover the important aspects of the components?
